...
| Legacy Method | Legacy Endpoint | V4 Method | V4 Endpoint | Notes |
| ----- | ----- | ----- | ----- | ----- |
| POST | `/v2/teams/{team_id}/actions` ([Create a Custom Action](https://developer.frame.io/api/reference/operation/createActionForTeam/)) | POST | /POST `/v4/accounts/{account_id}/workspaces/{workspace_id}/actions` ([Create Custom Action](https://developer.adobe.com/frameio/api/experimental/#tag/Custom-Actions/operation/actions.create)) | Create a custom action in a workspace. |
| DELETE | `/v2/actions/{action_id}` ([Delete a Custom Action](https://developer.frame.io/api/reference/operation/deleteAction/)) | DELETE | `/v4/accounts/{account_id}/actions/#{action_id}` ([Delete Custom Action](https://developer.adobe.com/frameio/api/experimental/#tag/Custom-Actions/operation/actions.create)) | Delete a custom action. |
