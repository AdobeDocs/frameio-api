...
**Note** You may also see a 403 returned if your account is locked. In this scenario, we'll inform you of this via the response description. There are several conditions that could place your account in this state so you can visit [this article](https://help.frame.io/en/articles/2673548-plan-limits-in-frame-io) for more information or reach out to Frame.io support if you need help getting your account back into good standing.
